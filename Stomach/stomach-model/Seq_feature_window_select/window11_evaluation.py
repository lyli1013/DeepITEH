...
checkpoint_dir = '/data/lyli/Stomach/stomach-model/Seq_feature_exact/window11'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Stomach/stomach-model/Seq_feature_exact/window11/checkpoints'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Stomach/stomach-model/Seq_feature_exact/window11/checkpoints/final_seq_model'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)
...
filename3 = "/data/lyli/Stomach/stomach-enhancers-windows/stomach-enhancers-300bp/window11_test_789.txt"
...
# Load SeqPoseDict
token_dict = np.load('/data/lyli/Stomach/stomach-model/Seq_feature_exact/window11/ModelDict_sequence.npy',
