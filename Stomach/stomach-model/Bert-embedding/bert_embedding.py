...
filename3 = "/data/lyli/Stomach/Processed_dataset/enhancer/window11_train_3154.txt"
filename4 = "/data/lyli/Stomach/Processed_dataset/nenhancer/window11_train_3154.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Stomach/stomach-model/Bert-embedding/stomach_seq_Dict.npy', token_dict)
...
with open('/data/lyli/Stomach/stomach-model/Bert-embedding/stomach_seq_train_6308_wordVector.txt', 'w') as outfile:
