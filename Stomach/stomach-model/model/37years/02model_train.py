...
checkpoint_dir = '/data/lyli/Stomach/stomach-model/Bert_LSTM_DNN_model/37years/final_model_37years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/stomach_37years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/stomach_37years_model.json"  # First layer model
...
# load omics feature
# training dataset
filename1 = "/data/lyli/Stomach/Processed_dataset/enhancer/en_feature_37years_RE_AE_train3154.txt"
filename2 = "/data/lyli/Stomach/Processed_dataset/nenhancer/nen_feature_37years_RE_AE_train3154.txt"
