...
checkpoint_dir = '/data/lyli/Stomach/stomach-model/Bert_LSTM_DNN_model/53years/final_model_53years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/stomach_53years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/stomach_53years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Stomach/stomach-model/Bert_LSTM_DNN_model/53years/stomach_53years_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Stomach/Processed_dataset/enhancer/en_feature_53years_RE_AE_test789.txt"  # 测试集
filename2 = "/data/lyli/Stomach/Processed_dataset/nenhancer/nen_feature_53years_RE_AE_test789.txt"
