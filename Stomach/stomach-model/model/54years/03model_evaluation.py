...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Stomach/stomach-model/Bert_LSTM_DNN_model/54years/stomach_54years_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Stomach/Processed_dataset/enhancer/en_feature_54years_RE_AE_test789.txt"  # 测试集
filename2 = "/data/lyli/Stomach/Processed_dataset/nenhancer/nen_feature_54years_RE_AE_test789.txt"
