...
featurename = '/data/lyli/Stomach/stomach-Multi-omics_data/stomach-53years/Enhancer_peak_distribution/H3K36me3/'
w = 1
...
mult = ['window01.fa', 'window02.fa', 'window03.fa']
for j in mult:
    have_peak_enhancer_nums = 0
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Stomach/stomach-enhancers-windows/stomach-enhancers-2100bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
