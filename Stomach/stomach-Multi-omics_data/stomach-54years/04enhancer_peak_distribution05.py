...
featurename = '/data/lyli/Stomach/stomach-Multi-omics_data/stomach-54years/Enhancer_peak_distribution/H3K36me3/'
w = 1
...
for j in mult:
    ...
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Stomach/stomach-enhancers-windows/stomach-enhancers-400bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
