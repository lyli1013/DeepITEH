...
featurename = '/data/lyli/Stomach/NoEnhancer/'
enhancers_feature = []
H3K4me1_value_sum1 = []
H3K4me3_value_sum2 = []
H3K9me3_value_sum4 = []
...
for window_extend_size in window_extend:
    for record in SeqIO.parse("/data/lyli/Stomach/NoEnhancer/NoEnhancer3943_6001.fa", "fasta"):
        name = record.id
...
np.savetxt(featurename + 'nen_feature_3943_37years.txt', enhancers_feature, encoding='utf_8_sig', delimiter=' ', fmt='%.3f')
