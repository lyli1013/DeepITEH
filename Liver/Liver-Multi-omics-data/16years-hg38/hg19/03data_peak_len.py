...
for i in omics_data:
    print("这是组学数据：", i)
    content_liver_omics = []
    with open("/data/lyli/deep-dataset/Multi-omics_data/16years_right_liver_hg38/01/hg19/" + i + ".bed")as f:
        for line in f:
    ...
    newfile = open("/data/lyli/deep-dataset/Multi-omics_data/16years_right_liver_hg38/01/hg19/omics_data_len/" + i + ".txt", 'w')
    for a in omics_len:
        newfile.write(str(a) + "\n")
    newfile.close()