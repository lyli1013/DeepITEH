...
checkpoint_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window03'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window03/checkpoints'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window03/checkpoints/final_seq_mode'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

output_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window03/output'  # Store model files
...
filename3 = "/data/lyli/deep-dataset/Processed_dataset/liver_Experiment/method03/Sequence_feature/enhancer/window03/train_enseq2537_300.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Project/Liver_model/Seq_feature_exact/window03/ModelDict_sequence.npy', token_dict)
