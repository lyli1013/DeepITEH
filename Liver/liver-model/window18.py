...
checkpoint_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window18'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window18/checkpoints'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window18/checkpoints/final_seq_model'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

output_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window18/output'  # Store model files
...
filename1 = "/data/lyli/deep-dataset/Processed_dataset/liver_Experiment/method03/Sequence_feature/enhancer/window18/train_enseq2537_300.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Project/Liver_model/Seq_feature_exact/window18/ModelDict_sequence.npy', token_dict)
...
# evaluation model
filename3 = "/data/lyli/deep-dataset/Processed_dataset/liver_Experiment/method03/Sequence_feature/enhancer/window18/test_enseq634_300.txt"
...
# Load SeqPoseDict
token_dict = np.load('/data/lyli/Project/Liver_model/Seq_feature_exact/window18/ModelDict_sequence.npy', allow_pickle=True).item()
