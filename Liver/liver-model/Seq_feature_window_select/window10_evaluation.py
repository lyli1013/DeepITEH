...
checkpoint_dir = '/data/lyli/Project/Liver_model/Seq_feature_exact/window10/checkpoints/final_seq_model'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)
...
filename3 = "/data/lyli/deep-dataset/Processed_dataset/liver_Experiment/method03/Sequence_feature/enhancer/window10/test_enseq634_300.txt"
...
# Load SeqPoseDict
token_dict = np.load('/data/lyli/Project/Liver_model/Seq_feature_exact/window10/ModelDict_sequence.npy', allow_pickle=True).item()
