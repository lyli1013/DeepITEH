...
checkpoint_dir = '../Liver/liver-model/model/16years/final_model_16years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/liver_16years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/liver_16years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    #dataframe.to_csv("../Liver/liver-model/model/16years/liver_16years_method.csv", index=False, sep=',')
...
filename1 = "../Liver/Processed_dataset/enhancer/en_feature_16years_RE_AE_test634.txt"  # 训练集
filename2 = "../lyli/Liver/Processed_dataset/nenhancer/nen_feature_16years_RE_AE_test634.txt"
filename3 = "../lyli/Liver/Processed_dataset/enhancer/test_enseq634_300.txt"
filename4 = "../lyli/Liver/Processed_dataset/nenhancer/test_nenseq634_300.txt"
...
# load bert model
config_path = '../Liver/liver-model/Bert-embedding/cased_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '../Liver/liver-model/Bert-embedding/cased_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '../Liver/liver-model/Bert-embedding/cased_L-12_H-768_A-12/vocab.txt'
model_bert = load_trained_model_from_checkpoint(config_path, checkpoint_path)

# Load SeqPoseDict
token_dict = np.load('../Liver/liver-model/model/Bert-embedding/liver_seq_Dict.npy', allow_pickle=True).item()
