...
X_seq_train = np.loadtxt('../Liver/liver_model/model/Bert-embedding/liver_traindataset_seq_wordVector.txt', delimiter=',').reshape((5074, 512, 768))
X_seq_train = np.array(X_seq_train)
# Y_train = wordVectorTarList

# load omics feature
# training dataset
filename1 = "../Liver/Processed_dataset/enhancer/en_feature_16years_RE_AE_train2537.txt"
