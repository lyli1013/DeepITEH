...
checkpoint_dir = '../Liver/liver-model/model/31years/final_model_31years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/liver_31years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/liver_31years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    #dataframe.to_csv("../Liver/liver-model/Bert_LSTM_DNN_model/31years/liver_31years_method.csv", index=False, sep=',')
...
filename1 = "../Liver/Processed_dataset/enhancer/en_feature_31years_RE_AE_test634.txt"  # 训练集
filename2 = "../Liver/Processed_dataset/nenhancer/nen_feature_31years_RE_AE_test634.txt"
filename3 = "../Liver/Processed_dataset/enhancer/test_enseq634_300.txt"
filename4 = "../Liver/Processed_dataset/nenhancer/test_nenseq634_300.txt"
...
# Load SeqPoseDict
token_dict = np.load('../Liver/liver-model/Bert-embedding/liver_seq_Dict.npy', allow_pickle=True).item()
