...
X_seq_train_val = np.loadtxt('../Liver/liver_model/model/Bert_embedding/liver_traindataset_seq_wordVector.txt', delimiter=',').reshape((5074, 512, 768))
...
# load omics feature
filename1 = "../Liver/Processed_dataset/enhancer/en_feature_31years_RE_AE_train2537.txt"  # 训练集
