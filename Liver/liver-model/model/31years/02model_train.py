...
checkpoint_dir = '../Liver/liver_model/model/31years/final_model_31years'  # Store model files
...
X_seq_train = np.loadtxt('../Liver/liver_model/model/Bert_embedding/liver_traindataset_seq_wordVector.txt', delimiter=',').reshape((5074, 512, 768))
X_seq_train = np.array(X_seq_train)
# Y_train = wordVectorTarList

# load omics feature
# training dataset
filename1 = "../Liver/Processed_dataset/enhancer/en_feature_31years_RE_AE_train2537.txt"
filename2 = "../Liver/Processed_dataset/nenhancer/nen_feature_31years_RE_AE_train2537.txt"
