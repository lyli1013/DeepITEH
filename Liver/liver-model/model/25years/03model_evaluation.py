...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    #dataframe.to_csv("../Liver/liver-model/Bert_LSTM_DNN_model/25years/liver_method.csv", index=False, sep=',')
...
filename1 = "../Liver/Processed_dataset/enhancer/en_feature_25years_RE_AE_test634.txt"  # 训练集
filename2 = "../Liver/Processed_dataset/nenhancer/nen_feature_25years_RE_AE_test634.txt"
