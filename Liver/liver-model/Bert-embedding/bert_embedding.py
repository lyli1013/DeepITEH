...
filename3 = "../Liver/Processed_dataset/enhancer/train_enseq2537_300.txt"
filename4 = "../Liver/Processed_dataset/nenhancer/train_nenseq2537_300.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('../Liver/liver-model/Bert-embedding/liver_seq_Dict.npy', token_dict)
...
with open('/data/lyli/Liver/liver-model/Bert-embedding/liver_traindataset_seq_wordVector.txt', 'w') as outfile:
