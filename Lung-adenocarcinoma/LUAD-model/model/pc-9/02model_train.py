...
X_seq_train = np.loadtxt('/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert-embedding/LUAD_seq_train_1956_wordVector.txt', delimiter=',').reshape((1956, 512, 768))
X_seq_train = np.array(X_seq_train)
# Y_train = wordVectorTarList

# load omics feature
# training dataset
filename1 = "/data/lyli/Lung-adenocarcinoma/Processed_dataset/enhancer/en_feature_pc9_RE_AE_train978.txt"
filename2 = "/data/lyli/Lung-adenocarcinoma/Processed_dataset/nenhancer/nen_feature_pc9_RE_AE_train978.txt"
