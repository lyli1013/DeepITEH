...
checkpoint_dir = '/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert_LSTM_DNN_model/pc-9/final_model_pc-9'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/LUAD_pc-9_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/LUAD_pc-9_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert_LSTM_DNN_model/pc-9/LUAD_pc-9_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Lung-adenocarcinoma/Processed_dataset/enhancer/en_feature_pc9_RE_AE_test200.txt"  # 测试集
filename2 = "/data/lyli/Lung-adenocarcinoma/Processed_dataset/nenhancer/nen_feature_pc9_RE_AE_test200.txt"
filename3 = "/data/lyli/Lung-adenocarcinoma/Processed_dataset/enhancer/LUAD-enhancers_test_enseq200.txt"
...
# load bert model
config_path = '/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert-embedding/cased_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert-embedding/cased_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert-embedding/cased_L-12_H-768_A-12/vocab.txt'
model_bert = load_trained_model_from_checkpoint(config_path, checkpoint_path)

# Load SeqPoseDict
token_dict = np.load('/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert-embedding/luad_seq_Dict.npy', allow_pickle=True).item()
