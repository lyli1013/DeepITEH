...
filename3 = "/data/lyli/Lung-adenocarcinoma/Processed_dataset/enhancer/LUAD-enhancers_train_enseq978.txt"
filename4 = "/data/lyli/Lung-adenocarcinoma/Processed_dataset/nenhancer/NoEnhancer978_300.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert-embedding/luad_seq_Dict.npy', token_dict)
...
with open('/data/lyli/Lung-adenocarcinoma/LUAD-model/Bert-embedding/LUAD_seq_train_1956_wordVector.txt', 'w') as outfile:
