...
featurename = '/data/lyli/Lung-adenocarcinoma/LUAD-Multi-omics_data/PC-9/Enhancer_peak_distribution/H3K9me3/'
w = 1
...
for j in mult:
    ...
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Lung-adenocarcinoma/LUAD-enhancers-windows/LUAD-enhancers-400bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
