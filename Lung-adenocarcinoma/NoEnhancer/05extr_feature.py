...
for window_extend_size in window_extend:
    for record in SeqIO.parse("../Lung-adenocarcinoma/NoEnhancer/NoEnhancer1178_300.fa", "fasta"):
        name = record.id
...
np.savetxt(featurename + 'nen_feature_pc9_1178.txt', enhancers_feature, encoding='utf_8_sig', delimiter=' ', fmt='%.3f')
