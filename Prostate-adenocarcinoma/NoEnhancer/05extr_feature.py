...
featurename = '/data/lyli/Prostate-adenocarcinoma/Processed_dataset-new/nenhancer/'
enhancers_feature = []
H3K4me1_value_sum1 = []
H3K4me3_value_sum2 = []
H3K9me3_value_sum4 = []
...
for window_extend_size in window_extend:
    for record in SeqIO.parse("/data/lyli/Prostate-adenocarcinoma/Processed_dataset-new/nenhancer/test_nenseq193.fa", "fasta"):
        name = record.id
...
np.savetxt(featurename + 'nen_feature_193_PC-3-.txt', enhancers_feature, encoding='utf_8_sig', delimiter=' ', fmt='%.3f')
