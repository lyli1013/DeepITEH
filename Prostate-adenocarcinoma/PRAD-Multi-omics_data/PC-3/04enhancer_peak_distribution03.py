...
featurename = '/data/lyli/Prostate-adenocarcinoma/PRAD-Multi-omics_data/PC-3/Enhancer_peak_distribution/H3K9me3/'
w = 1
...
mult = ['window01.fa', 'window02.fa', 'window03.fa', 'window04.fa', 'window05.fa', 'window06.fa', 'window07.fa', 'window08.fa', 'window09.fa', 'window10.fa',
        'window11.fa', 'window12.fa', 'window13.fa', 'window14.fa', 'window15.fa']
for j in mult:
    have_peak_enhancer_nums = 0
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Prostate-adenocarcinoma/PRAD-enhancers-windows/PRAD-enhancers-400bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
