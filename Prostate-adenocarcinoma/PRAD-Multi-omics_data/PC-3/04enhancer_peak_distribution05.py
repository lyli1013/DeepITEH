...
featurename = '/data/lyli/Prostate-adenocarcinoma/PRAD-Multi-omics_data/PC-3/Enhancer_peak_distribution/H3K36me3/'
w = 1
...
for j in mult:
    ...
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Prostate-adenocarcinoma/PRAD-enhancers-windows/PRAD-enhancers-600bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
