...
checkpoint_dir = '/data/lyli/Prostate-adenocarcinoma/PRAD-model/Seq_feature_exact/window11'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Prostate-adenocarcinoma/PRAD-model/Seq_feature_exact/window11/checkpoints'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Prostate-adenocarcinoma/PRAD-model/Seq_feature_exact/window11/checkpoints/final_seq_model'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)
...
filename3 = "/data/lyli/Prostate-adenocarcinoma/PRAD-enhancers-windows/PRAD-enhancers-300bp/window11_test_193.txt"
...
# Load SeqPoseDict
token_dict = np.load('/data/lyli/Prostate-adenocarcinoma/PRAD-model/Seq_feature_exact/window11/ModelDict_sequence.npy',
