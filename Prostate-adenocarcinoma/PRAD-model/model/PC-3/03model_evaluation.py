...
checkpoint_dir = '/data/lyli/Prostate-adenocarcinoma/PRAD-model/Bert_LSTM_DNN_model/PC-3/final_model_pc3'  # Store model files
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Prostate-adenocarcinoma/PRAD-model/Bert_LSTM_DNN_model/PC-3/PRAD_pc-3_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Prostate-adenocarcinoma/Processed_dataset-new/enhancer/en_feature_PC-3_RE_AE_test193.txt"  # 测试集
filename2 = "/data/lyli/Prostate-adenocarcinoma/Processed_dataset-new/nenhancer/nen_feature_PC-3_RE_AE_test193.txt"
filename3 = "/data/lyli/Prostate-adenocarcinoma/Processed_dataset-new/enhancer/test_enseq193.txt"
...
# Load SeqPoseDict
token_dict = np.load('/data/lyli/Prostate-adenocarcinoma/PRAD-model/Bert-embedding/prad_seq_Dict.npy', allow_pickle=True).item()
