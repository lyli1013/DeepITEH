...
X_seq_train_val = np.loadtxt('/data/lyli/Prostate-adenocarcinoma/PRAD-model/Bert-embedding/PRAD_seq_train_1542_wordVector.txt', delimiter=',').reshape((1542, 512, 768))
