...
X_seq_train_val = np.loadtxt('/data/lyli/Pancreatic-adenocarcinoma/PAAD-model/Bert-embedding/PAAD_seq_train_1336_wordVector.txt', delimiter=',').reshape((1336, 512, 768))
