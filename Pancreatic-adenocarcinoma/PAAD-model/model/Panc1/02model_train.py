...
X_seq_train = np.loadtxt('/data/lyli/Pancreatic-adenocarcinoma/PAAD-model/Bert-embedding/PAAD_seq_train_1336_wordVector.txt', delimiter=',').reshape((1336, 512, 768))
X_seq_train = np.array(X_seq_train)
# Y_train = wordVectorTarList

# load omics feature
# training dataset
filename1 = "/data/lyli/Pancreatic-adenocarcinoma/Processed_dataset/enhancer/en_feature_Panc1_RE_AE_train668.txt"
filename2 = "/data/lyli/Pancreatic-adenocarcinoma/Processed_dataset/nenhancer/nen_feature_Panc1_RE_AE_train668.txt"
