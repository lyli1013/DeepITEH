...
filename3 = "/data/lyli/Pancreatic-adenocarcinoma/Processed_dataset/enhancer/train_enseq668.txt"
filename4 = "/data/lyli/Pancreatic-adenocarcinoma/Processed_dataset/nenhancer/train_nenseq668.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Pancreatic-adenocarcinoma/PAAD-model/Bert-embedding/paad_seq_Dict.npy', token_dict)
...
with open('/data/lyli/Pancreatic-adenocarcinoma/PAAD-model/Bert-embedding/PAAD_seq_train_1336_wordVector.txt', 'w') as outfile:
