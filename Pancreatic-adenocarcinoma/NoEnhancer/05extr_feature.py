...
for window_extend_size in window_extend:
    for record in SeqIO.parse("../Pancreatic-adenocarcinoma/NoEnhancer/nenseq835.fa", "fasta"):
        name = record.id
...
np.savetxt(featurename + 'nen_feature_835_Panc1.txt', enhancers_feature, encoding='utf_8_sig', delimiter=' ', fmt='%.3f')
