...
featurename = '/data/lyli/Pancreatic-adenocarcinoma/PAAD-Multi-omics_data/Panc1/Enhancer_peak_distribution/H3K4me3/'
w = 1
...
for j in mult:
    ...
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Pancreatic-adenocarcinoma/PAAD-enhancers-windows/PAAD-enhancers-1600bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
        ...
        if j == 'window01.fa':
            start_enhancer = start_enhancer + 1000
        if j == 'window05.fa':
            end_enhancer = end_enhancer -1000
