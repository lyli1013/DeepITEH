...
featurename = '/data/lyli/Liver-hepatocellular-carcinoma/LIHC-Multi-omics_data/HepG2/Enhancer_peak_distribution/H3K9me3/'
w = 1
...
mult = ['window01.fa', 'window02.fa', 'window03.fa', 'window04.fa', 'window05.fa', 'window06.fa', 'window07.fa', 'window08.fa', 'window09.fa']
for j in mult:
    have_peak_enhancer_nums = 0
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Liver-hepatocellular-carcinoma/LIHC-enhancers-windows/LIHC-enhancers-800bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
        ...
        if j == 'window01.fa':
            start_enhancer = start_enhancer + 600
        if j == 'window09.fa':
            end_enhancer = end_enhancer -600
