...
featurename = '/data/lyli/Liver-hepatocellular-carcinoma/LIHC-Multi-omics_data/HepG2/Enhancer_peak_distribution/H3K36me3/'
w = 1
...
mult = ['window01.fa', 'window02.fa', 'window03.fa', 'window04.fa', 'window05.fa', 'window06.fa', 'window07.fa', 'window08.fa', 'window09.fa', 'window10.fa',
        'window11.fa', 'window12.fa', 'window13.fa']
for j in mult:
    have_peak_enhancer_nums = 0
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Liver-hepatocellular-carcinoma/LIHC-enhancers-windows/LIHC-enhancers-500bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
