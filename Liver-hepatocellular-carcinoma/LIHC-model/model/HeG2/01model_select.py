...
X_seq_train_val = np.loadtxt('/data/lyli/Liver-hepatocellular-carcinoma/LIHC-model/Bert-embedding/LIHC_seq_train_708_wordVector.txt', delimiter=',').reshape((708, 512, 768))
