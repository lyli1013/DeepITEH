...
filename3 = "/data/lyli/Liver-hepatocellular-carcinoma/Processed_dataset/enhancer/train_enseq354.txt"
filename4 = "/data/lyli/Liver-hepatocellular-carcinoma/Processed_dataset/nenhancer/train_nenseq354.txt"
...
# Load Bert's vocabulary into the dictionary.
token_dict = {}
...
# Update the glossary dictionary so that each word in the sequence is present in the dictionary.
n = 1
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Liver-hepatocellular-carcinoma/LIHC-model/Bert-embedding/lihc_seq_Dict.npy', token_dict)
...
with open('/data/lyli/Liver-hepatocellular-carcinoma/LIHC-model/Bert-embedding/LIHC_seq_train_708_wordVector.txt', 'w') as outfile:
