...
featurename = '/data/lyli/Lung/Lung-Multi-omics_data/lower_lobe_of_left_lung_59years_hg38/hg19/Enhancer_peak_distribution/H3K9me3/'
w = 1
...
mult = ['window01.fa', 'window02.fa', 'window03.fa', 'window04.fa', 'window05.fa', 'window06.fa', 'window07.fa']
for j in mult:
    have_peak_enhancer_nums = 0
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Lung/lung-enhancers-windows/lung-enhancers-1100bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
