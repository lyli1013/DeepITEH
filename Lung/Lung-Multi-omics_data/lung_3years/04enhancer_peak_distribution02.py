...
featurename = '/data/lyli/Lung/Lung-Multi-omics_data/lung_3years/Enhancer_peak_distribution/H3K4me3/'
w = 1
...
for j in mult:
    ...
    for record in SeqIO.parse("/data/lyli/Lung/lung-enhancers-windows/lung-enhancers-1100bp/" + j, "fasta"):
        ...
        if j == 'window01.fa':
            start_enhancer = start_enhancer + 850
        if j == 'window07.fa':
            end_enhancer = end_enhancer - 850
