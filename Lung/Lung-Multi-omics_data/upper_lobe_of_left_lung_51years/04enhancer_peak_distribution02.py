...
featurename = '/data/lyli/Lung/Lung-Multi-omics_data/upper_lobe_of_left_lung_51years/Enhancer_peak_distribution/H3K4me3/'
w = 1
...
for j in mult:
    ...
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Lung/lung-enhancers-windows/lung-enhancers-1500bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
        ...
        if j == 'window01.fa':
            start_enhancer = start_enhancer + 750
        if j == 'window05.fa':
            end_enhancer = end_enhancer - 750
