...
featurename = '/data/lyli/Lung/Lung-Multi-omics_data/upper_lobe_of_left_lung_37years/Enhancer_peak_distribution/H3K27ac/'
w = 1
...
for j in mult:
    ...
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Lung/lung-enhancers-windows/lung-enhancers-900bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
