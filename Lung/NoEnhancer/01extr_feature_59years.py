...
featurename = '/data/lyli/Lung/NoEnhancer/'
enhancers_feature = []
H3K4me1_value_sum1 = []
H3K4me3_value_sum2 = []
H3K9me3_value_sum4 = []
...
for window_extend_size in window_extend:
    for record in SeqIO.parse("/data/lyli/Lung/NoEnhancer/NoEnhancer_seq_6481_300.fa", "fasta"):
        name = record.id
...
np.savetxt(featurename + 'NoEnhancer_59years_feature_6481_6001.txt', enhancers_feature, encoding='utf_8_sig', delimiter=' ', fmt='%.3f')
