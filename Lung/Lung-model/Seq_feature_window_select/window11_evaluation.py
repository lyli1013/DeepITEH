...
checkpoint_dir = '/data/lyli/Lung/Lung-model/Seq_feature_exact/window11'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Lung/Lung-model/Seq_feature_exact/window11/checkpoints'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Lung/Lung-model/Seq_feature_exact/window11/checkpoints/final_seq_model'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)
...
filename3 = "/data/lyli/Lung/lung-enhancers-windows/lung-enhancers-300bp/window11_test_1296.txt"
...
# Load SeqPoseDict
token_dict = np.load('/data/lyli/Lung/Lung-model/Seq_feature_exact/window11/ModelDict_sequence.npy',
