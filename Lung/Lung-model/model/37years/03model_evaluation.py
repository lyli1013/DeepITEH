...
checkpoint_dir = '/data/lyli/Lung/Lung-model/Bert_LSTM_DNN_model/37years/final_model_37years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/lung_37years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/lung_37years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Lung/Lung-model/Bert_LSTM_DNN_model/37years/lung_37years_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Lung/Processed_dataset/enhancer/en_feature_37years_RE_AE_test1296.txt"  # 训练集
filename2 = "/data/lyli/Lung/Processed_dataset/nenhancer/nen_feature_37years_RE_AE_test1296.txt"
