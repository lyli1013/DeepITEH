...
checkpoint_dir = '/data/lyli/Lung/Lung-model/Bert_LSTM_DNN_model/59years/final_model_59years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/lung_59years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/lung_59years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Lung/Lung-model/Bert_LSTM_DNN_model/59years/lung_59years_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Lung/Processed_dataset/enhancer/en_feature_59years_RE_AE_test1296.txt"  # 训练集
filename2 = "/data/lyli/Lung/Processed_dataset/nenhancer/nen_feature_59years_RE_AE_test1296.txt"
