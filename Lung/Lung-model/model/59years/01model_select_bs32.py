...
X_seq_train_val = np.loadtxt('/data/lyli/Lung/Lung-model/Bert_embedding/lung_seq_train_10370_wordVector.txt', delimiter=',').reshape((10370, 512, 768))
...
filename1 = "/data/lyli/Lung/Processed_dataset/enhancer/en_feature_59years_RE_AE_train5185.txt"
filename2 = "/data/lyli/Lung/Processed_dataset/nenhancer/nen_feature_59years_RE_AE_train5185.txt"
