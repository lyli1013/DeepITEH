...
checkpoint_dir = '/data/lyli/Lung/Lung-model/Bert_LSTM_DNN_model/54years/final_model_54years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/lung_54years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/lung_54years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Lung/Lung-model/Bert_LSTM_DNN_model/54years/lung_54years_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Lung/Processed_dataset/enhancer/en_feature_54years_RE_AE_test1296.txt"  # 训练集
filename2 = "/data/lyli/Lung/Processed_dataset/nenhancer/nen_feature_54years_RE_AE_test1296.txt"
filename3 = "/data/lyli/Lung/Processed_dataset/enhancer/window11_test_enseq1296.txt"
filename4 = "/data/lyli/Lung/Processed_dataset/nenhancer/NoEnhancer_test_enseq1296.txt"
...
# load bert model
config_path = '/data/lyli/Lung/Lung-model/Bert_embedding/cased_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/data/lyli/Lung/Lung-model/Bert_embedding/cased_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/data/lyli/Lung/Lung-model/Bert_embedding/cased_L-12_H-768_A-12/vocab.txt'
model_bert = load_trained_model_from_checkpoint(config_path, checkpoint_path)

# Load SeqPoseDict
token_dict = np.load('/data/lyli/Lung/Lung-model/Bert_embedding/lung_seq_Dict.npy', allow_pickle=True).item()
