...
filename3 = "/data/lyli/Lung/Processed_dataset/enhancer/window11_train_5185.txt"
filename4 = "/data/lyli/Lung/Processed_dataset/nenhancer/NoEnhancer_seq_train_5185.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Lung/Lung-model/Bert_embedding/lung_seq_Dict.npy', token_dict)
...
with open('/data/lyli/Lung/Lung-model/Bert_embedding/lung_seq_train_10370_wordVector.txt', 'w') as outfile:
