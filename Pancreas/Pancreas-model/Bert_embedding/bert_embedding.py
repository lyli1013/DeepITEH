...
filename3 = "/data/lyli/Pancreas/Processed_dataset-new/enhancer/window11_train_enseq2694.txt"
filename4 = "/data/lyli/Pancreas/Processed_dataset-new/nenhancer/window11_train_nenseq2694.txt"
...
for pairs in wordVectorSeqList:
    for token in pairs:
        if token not in token_dict:
            ...
            n += 1
# print(token_dict)
np.save('/data/lyli/Pancreas/Pancreas-model/Bert_embedding/pancreas_seq_Dict-new.npy', token_dict)
...
with open('/data/lyli/Pancreas/Pancreas-model/Bert_embedding/pancreas_seq_train_5388_wordVector-new.txt', 'w') as outfile:
