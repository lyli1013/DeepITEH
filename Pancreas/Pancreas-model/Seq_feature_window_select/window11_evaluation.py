...
checkpoint_dir = '/data/lyli/Pancreas/Pancreas-model/Seq_feature_exact/window11'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Pancreas/Pancreas-model/Seq_feature_exact/window11/checkpoints'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

checkpoint_dir = '/data/lyli/Pancreas/Pancreas-model/Seq_feature_exact/window11/checkpoints/final_seq_model'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)
...
filename3 = "/data/lyli/Pancreas/pancreas-enhancers-windows/pancreas-enhancers-300bp/window11_test_674.txt"
filename4 = "/data/lyli/Pancreas/Processed_dataset/nenhancer/window11_test_enseq674.txt"
...
# Load SeqPoseDict
token_dict = np.load('/data/lyli/Pancreas/Pancreas-model/Seq_feature_exact/window11/ModelDict_sequence.npy',
