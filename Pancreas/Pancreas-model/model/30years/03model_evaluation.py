...
checkpoint_dir = '/data/lyli/Pancreas/Pancreas-model/Bert_LSTM_DNN_model/30years/final_model_30years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/pancreas_30years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/pancreas_30years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Pancreas/Pancreas-model/Bert_LSTM_DNN_model/30years/pancreas_30years_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Pancreas/Processed_dataset-new/enhancer/en_feature_30years_RE_AE_test674.txt"  # 测试集
filename2 = "/data/lyli/Pancreas/Processed_dataset-new/nenhancer/nen_feature_30years_RE_AE_test674.txt"
