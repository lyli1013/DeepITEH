...
k_merList = [2]  # kmer
kkk = k_merList[0]
BATCH_SIZE = 16   # best_parameter
EPCOHS = 8         # best_parameter
...
checkpoint_dir = '/data/lyli/Pancreas/Pancreas-model/Bert_LSTM_DNN_model/34years/final_model_34years'  # Store model files
if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
    os.mkdir(checkpoint_dir)

model_weight_filepath = checkpoint_dir + "/pancreas_34years_model.h5"  # First layer model
model_structure_filepath = checkpoint_dir + "/pancreas_34years_model.json"  # First layer model
...
def Model_AUC(model, X_test_first, Y_test_first, BATCH_SIZE):
    ...
    dataframe.to_csv("/data/lyli/Pancreas/Pancreas-model/Bert_LSTM_DNN_model/34years/pancreas_34years_method.csv", index=False, sep=',')
...
filename1 = "/data/lyli/Pancreas/Processed_dataset-new/enhancer/en_feature_34years_RE_AE_test674.txt"  # 测试集
filename2 = "/data/lyli/Pancreas/Processed_dataset-new/nenhancer/nen_feature_34years_RE_AE_test674.txt"
filename3 = "/data/lyli/Pancreas/Processed_dataset-new/enhancer/window11_test_enseq674.txt"
filename4 = "/data/lyli/Pancreas/Processed_dataset-new/nenhancer/window11_test_nenseq674.txt"
...
# load bert model
config_path = '/data/lyli/Pancreas/Pancreas-model/Bert_embedding/cased_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/data/lyli/Pancreas/Pancreas-model/Bert_embedding/cased_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/data/lyli/Pancreas/Pancreas-model/Bert_embedding/cased_L-12_H-768_A-12/vocab.txt'
model_bert = load_trained_model_from_checkpoint(config_path, checkpoint_path)

# Load SeqPoseDict
token_dict = np.load('/data/lyli/Pancreas/Pancreas-model/Bert_embedding/pancreas_seq_Dict-new.npy', allow_pickle=True).item()
