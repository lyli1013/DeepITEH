...
# checkpoint_dir = '/data/lyli/Project/Liver_model/Bert_LSTM_DNN_model/16years/select_model'  # Store model files
# if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
#     os.mkdir(checkpoint_dir)
#
# checkpoint_dir = '/data/lyli/Project/Liver_model/Bert_LSTM_DNN_model/16years/select_model/final_model_16years'  # Store model files
# if not os.path.exists(checkpoint_dir):  # if the path does not exist, generate it
#     os.mkdir(checkpoint_dir)
#
# # output_dir = '/data/lyli/Project/lly/Bert_LSTM_DNN/16years/output'  # Store model files
# # if not os.path.exists(output_dir):  # if the path does not exist, generate it
# #     os.mkdir(output_dir)
# filepath = checkpoint_dir + "/liver_16years_model_" + str(kkk) + "_mer" + ".hdf5"  # First layer model
...
X_seq_train_val = np.loadtxt('/data/lyli/Pancreas/Pancreas-model/Bert_embedding/pancreas_seq_train_5388_wordVector-new.txt', delimiter=',').reshape((5388, 512, 768))
...
# load omics feature
filename1 = "/data/lyli/Pancreas/Processed_dataset-new/enhancer/en_feature_34years_RE_AE_train2694.txt"
filename2 = "/data/lyli/Pancreas/Processed_dataset-new/nenhancer/nen_feature_34years_RE_AE_train2694.txt"
