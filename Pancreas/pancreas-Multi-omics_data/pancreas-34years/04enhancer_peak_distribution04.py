...
featurename = '/data/lyli/Pancreas/pancreas-Multi-omics_data/pancreas-34years/Enhancer_peak_distribution/H3K27ac/'
w = 1
...
for j in mult:
    ...
    enhancers_feature = []
    for record in SeqIO.parse("/data/lyli/Pancreas/pancreas-enhancers-windows/pancreas-enhancers-400bp/" + j, "fasta"):
        location_total = []
        distance_total = []
        signalValue_total = []
        name = record.id
