...
enhancers = []
for record in SeqIO.parse("/data/lyli/Pancreas/Processed_dataset-new/nenhancer/window11_test_enseq674.fa", "fasta"):
    name = record.id
    enhancers.append(name)

enhancers1484 = []
for record in SeqIO.parse("/data/lyli/Pancreas/Processed_dataset-new/nenhancer/NoEnhancer1484_300.fa", "fasta"):
    name = record.id
...
#     enhancers.remove(i)
# 
# newfile = open('/data/lyli/Pancreas/NoEnhancer/new/nenhancer_test.fa', 'w')
# for j in enhancers:
